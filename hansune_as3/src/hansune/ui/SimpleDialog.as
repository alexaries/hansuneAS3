package hansune.ui
{
    ...
    /**
     * <code>SimpleDialog</code> 를 통해 손쉽게 간단히 경고문구나 대화창을 띄울 수 있다. 
     * @author hyonsoohan
     * 
     */
    public class SimpleDialog extends EventDispatcher {
        ...
        private static var dialogArray:Vector.<SimpleDialog> = new Vector.<SimpleDialog>();
        ...
        public function set text(value:String):void {
			...
			if(SimpleDialog.isCenter){
				...
				for(var i:int=0; i< SimpleDialog.dialogArray.length; i++){
					//모션때문에 잠깐 스케일 변경
					...
					if(i==0){
						...
						dialogArray[i].y = dialogArray[i-1].y + 
							(dialogArray[i-1].height + dialogArray[i].height)/2 + 5;
         ...
         * @return 버튼이 포함된 EasyDialog 객체
         * 
         */
        public function setButton(btnName:String, onClickFnc:Function = null):SimpleDialog {
            isHideAfter = false;
        ...
        /**
         * 다이어로그를 화면에 표시한다. 
         * @return EasyDialog 객체
         * 
         */
        public function show():SimpleDialog {
            ...
            SimpleDialog.dialogArray.push(this);
        ...
        public static function hideAll():void {
            for each(var dialog:SimpleDialog in dialogArray){
                dialog.hide();
            }
        }
         ...
         * 
         */
        public static function show(context:DisplayObject, message:String,isHideAfter:Boolean = true, time:int = 3000):SimpleDialog {
            return SimpleDialog.create(context, message, isHideAfter, time).show();
        }
         ...
         * 
         */
        public static function create(context:DisplayObject, message:String,isHideAfter:Boolean = true, time:int = 3000):SimpleDialog{
            
            var fm:TextFormat = new TextFormat("Lucida Grande", 14, 0x262626);
            fm.bold = true;
            var dialog:SimpleDialog = new SimpleDialog();
